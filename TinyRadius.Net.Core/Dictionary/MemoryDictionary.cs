 ...
 * @see TinyRadius.dictionary.Dictionary
 * @see TinyRadius.dictionary.WritableDictionary
 */
public class MemoryDictionary :WritableDictionary {
	 ...
	 * @param typeCode attribute type code
	 * @return AttributeType or null
	 * @see TinyRadius.dictionary.Dictionary#getAttributeTypeByCode(int, int)
	 */
	 ...
	 * @return AttributeType or null
	 * @see TinyRadius.dictionary.Dictionary#getAttributeTypeByName(java.lang.String)
	 */
	 ...
	 * @see TinyRadius.dictionary.Dictionary#getVendorId(java.lang.String)
	 */
	 ...
	 * @see TinyRadius.dictionary.Dictionary#getVendorName(int)
	 */
